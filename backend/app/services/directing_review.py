...
- **consequence** — 한 렌즈의 결정이 다른 렌즈의 판단을 만든 경우. 가장 중요합니다.
  ...
  이 관계가 보이면 **고칠 곳은 원인 쪽**입니다. 영향받은 쪽을 고치면 증상만 사라집니다.

- **conflict** — 두 렌즈가 서로 반대되는 방향을 요구하는 경우.
  ✓ "촬영은 더 좁히자 하고, 미장센은 공간이 보여야 한다고 한다"
  감독이 무엇을 우선할지 정해야 하는 지점입니다.

- **agreement** — 두 렌즈가 같은 문제를 다른 근거로 짚은 경우.
  같은 원인이라면 한 번만 고치면 됩니다.
...
- consequence가 없으면 **change 판정이 있는 렌즈** 중 하나를 고르세요.
