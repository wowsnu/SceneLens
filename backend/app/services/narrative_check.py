...
- suggested_action: **한 문장, 50자 안쪽.** 문제를 판단한 컷 내용상의 근거만 씁니다.
- summary: **한 문장, 60자 안쪽.**

컷 플랜 점검에서는 operation에 항상 `keep`을 넣으세요. split, merge,
insert, delete 같은 해결책이나 조작을 제시하지 마세요. 감독이 판단할 수 있게
문제와 그 문제를 보여 주는 컷 내용만 말합니다. 대본 점검에서도 같습니다.
