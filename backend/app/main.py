...
from app.routes import cut_insert, cut_plan, directing_review, prompt_rewrite, scene_state, seam_design, seam_insert, shot_design, shot_fix, panel_image, reference_image, space_layout, fill_shot, image_gen, narrative, overlay, segment, sketch, story, strategy, viewer
...
app.include_router(cut_insert.router, prefix="/api")
